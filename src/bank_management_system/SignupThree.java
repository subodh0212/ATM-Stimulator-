...
public class SignupThree extends JFrame implements ActionListener{
	...
	SignupThree(String formno){
		...
		c7 =new JCheckBox("I hereby declares that thr above entered details are correct to the best of my konwledge");
		...
		if(ae.getSource()== submit) {
			...
			try {
				if(accountType.equals("")) {
					JOptionPane.showMessageDialog(null, "Account Type is requird");
				} else {
					Conn conn = new Conn();
